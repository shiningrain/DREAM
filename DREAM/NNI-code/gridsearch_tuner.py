...
import nni
from nni.common.hpo_utils import ParameterSpec, deformat_parameters, format_search_space, format_parameters
...
class GridSearchTuner(Tuner):
    ...
    **Implementation**
    ...
    def generate_parameters(self, *args, **kwargs):
        ...
        # print(history)
        if len(self.history)==0:# 2024xy # read from history
