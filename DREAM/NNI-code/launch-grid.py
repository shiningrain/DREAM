...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_time','-tm',default='24h', help='searching result path')
    ...
    # trial setting
    parser.add_argument('--source_param','-prm',default='./c100_initial/param_c100_1.pkl', type=str, help='source_param path')
    ...
    parser.add_argument('--hypermodel_path','-hp',default='./hypermodel-c100.pkl', type=str, help='hypermodel_path')
    ...
    experiment.config.experiment_name = 'C100 test 0806'
    ...
    experiment.config.trial_command = f'CUDA_VISIBLE_DEVICES={args.device} python c100.py \
