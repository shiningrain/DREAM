...
if __name__ == '__main__':
    ...
    parser.add_argument('--search_space','-sp',default='./search_space-image.json', help='searching result path')
    parser.add_argument('--max_trial','-tr',default=5, type=int, help='searching result path')
    parser.add_argument('--max_time','-tm',default='48h', help='searching result path')
    parser.add_argument('--port','-pt',default=8090, type=int,help='searching result path')
    parser.add_argument('--device','-dv',default=0, type=int,help='searching result path')

    # trial setting
    parser.add_argument('--source_param','-prm',default='./tiny_initial/param_tiny_1.pkl', type=str, help='source_param path')
    ...
    experiment.config.experiment_name = 'tiny test 0806'
    ...
    experiment.config.trial_command = f'CUDA_VISIBLE_DEVICES={args.device} python tiny.py \
