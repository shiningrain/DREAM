...
def main(params_dict,
    ...
    data,_=extract_dataset_np([x_train[:batch_size,...],y_train[:batch_size]],tmp_dir=tmp_dir,method='c100')
...
def convert_search_space(hyperparams,search_space_path='./search_space-c100.json'):
