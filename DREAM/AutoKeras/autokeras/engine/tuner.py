...
class LossHistory(keras.callbacks.Callback):
    ...
    def on_epoch_end(self,epoch,logs={}):
        ...
        # overhead['monitor_memory'].append(memory)
        # overhead['monitor_time'].append(time_use)
...
class AutoTuner(kerastuner.engine.tuner.Tuner):
    ...
    def _build_and_fit_model_greedy(self, trial, fit_args, fit_kwargs):
        ...
        # elif log_dict['cur_trial']>=15 and time_usage>=20000:#64800:
        # elif time_usage>=7200 and log_dict['cur_trial']>=20:
            ...
            # TODO: back
            # add_name=params_path.split('/param_')[-1]
    ...
    def _build_and_fit_model_beam(self, trial, fit_args, fit_kwargs):
        ...
        msg={}
        msg['epochs']=fit_kwargs['epochs']
        data,batch_size=extract_dataset(list(fit_kwargs['x'].as_numpy_iterator()),tmp_dir=tmp_dir,method=log_dict['data'])
        # msg['data']=data
        msg['batch']=batch_size
