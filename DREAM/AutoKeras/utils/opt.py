...
#                         while ('activation' not in new_config.keys()):
#                             current_layer-=1
#                             new_config=copy.deepcopy(model.layers[current_layer].get_config())
#                         new_config['activation']=activation
#                         new_layer=model.layers[current_layer].__class__(**new_config)
...
# model=load_model('/data/zxy/DL_autokeras/1Autokeras/test_codes/relu/b5e3c487/bn_model.h5')
